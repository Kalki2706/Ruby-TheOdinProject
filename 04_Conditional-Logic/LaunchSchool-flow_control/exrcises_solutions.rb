...
# 5. When you run the following code... You get the following error message.. "exercise.rb:8: syntax error, unexpected end-of-input, expecting keyword_end", Why do you get this error and how can you fix it?
...
# The error message is about ending the function with end keyword 
def equal_to_four(x)
    if x == 4
      puts "yup"
    else
